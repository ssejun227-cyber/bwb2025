/**
 * Gallery Page (English) - JavaScript
      ...
      <div class="gallery-footer__info">
        ...
        ${footer.phone ? `
          <p class="gallery-footer__row">
            <span class="gallery-footer__label">| Phone</span>
            <span class="gallery-footer__value">${footer.phone}</span>
          </p>
        ` : ''}
        ${footer.email ? `
          <p class="gallery-footer__row">
            <span class="gallery-footer__label">| Email</span>
            <span class="gallery-footer__value">${footer.email}</span>
          </p>
        ` : ''}
        ${footer.address ? `
          <p class="gallery-footer__row">
            <span class="gallery-footer__label">| Address</span>
